...
export default class Logger {
    ...
    public debug(...args: any) {
        ...
        if (typeof args === 'string') return console.log(`[${this.getDate().white.bold}] ${`DEBUG<${this.name}>`.bgBlue.bold}`,args);
        if (typeof args === 'object') return console.log(`[${this.getDate().white.bold}] ${`DEBUG<${this.name}>`.bgBlue.bold}`,args);
