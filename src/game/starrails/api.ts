	...
	GET_DATA_REGION: async function (name: string = "", seed: string = "", key: number = 5, version: string = "") {
		try {
			...
			const dataObj = ServerDispatchData.fromPartial({
				_AssetBundleVersionUpdateUrl: "https://autopatchos.starrails.com/asb/V1.0Live/output_4186973_52d0b74c56",
				...
				_DesignDataBundleVersionUpdateUrl: "https://autopatchos.starrails.com/design_data/V1.0Live/output_4188516_478ae5483e",
				name: 'YuukiSR',
				port: 22102,
				...
				customServiceUrl: "https://webstatic-sea.hoyoverse.com/csc-service-center-fe/index.html?sign_type=2&auth_appid=csc&authkey_ver=1&win_direction=portrait&page_id=11",
			...
			try {
				...
				rsp = ServerDispatchData.encode(ServerDispatchData.fromPartial({
