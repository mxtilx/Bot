...
export const ServerDispatchData = {
  ...
  fromJSON(object: any): ServerDispatchData {
    return {
      ...
      onlineReplayDownloadUrl: isSet(object.onlineReplayDownloadUrl) ? String(object.onlineReplayDownloadUrl) : "",
      redeemCodeUrl: isSet(object.redeemCodeUrl) ? String(object.redeemCodeUrl) : "",
      temporaryMaintenanceUrl: isSet(object.temporaryMaintenanceUrl) ? String(object.temporaryMaintenanceUrl) : "",
      ...
      teenagerPrivacyInGameUrl: isSet(object.teenagerPrivacyInGameUrl) ? String(object.teenagerPrivacyInGameUrl) : "",
  ...
  toJSON(message: ServerDispatchData): unknown {
    ...
    message.teenagerPrivacyInGameUrl !== undefined && (obj.teenagerPrivacyInGameUrl = message.teenagerPrivacyInGameUrl);
