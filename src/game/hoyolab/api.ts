...
export async function SearchRedeemCode(id_game = 2) {
...
export async function ClaimRedeem(uid = 0, region = "os_asia", key = "", game = "hk4e", ck_token = "", ck_acc_id = "") {
...
export async function DailyCheckIn(game = "hk4e", ck_token = "", ck_acc_id = "") {
	// hk4e = gs, hkrpg=sr for asia prod_official_asia
