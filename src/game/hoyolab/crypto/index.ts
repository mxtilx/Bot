...
//import { sleep, isEmpty } from "../../genshin/keys";

const log = new Logger("crypto");

function r(...args: string[]) {
  let t = readFileSync(resolve(__dirname, ...args)).toString()
  //log.info(t)
  return t;
}
...
export function loadKeys() {
  ...
  keys.set("4", r('../../genshin/keys/4-private.pem'));
  keys.set("5", r('../../genshin/keys/5-private.pem'));
  keys.set("Sign", r('../../genshin/keys/SigningKey.pem'));
  return keys;
}
