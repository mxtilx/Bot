...
export const QueryCurrRegionHttpRsp = {
  encode(message: QueryCurrRegionHttpRsp, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (
      message.clientRegionCustomConfigEncrypted !== undefined && message.clientRegionCustomConfigEncrypted.length !== 0
    ) {
  ...
  toJSON(message: QueryCurrRegionHttpRsp): unknown {
    ...
    message.regionCustomConfigEncrypted !== undefined &&
      (obj.regionCustomConfigEncrypted = base64FromBytes(
        message.regionCustomConfigEncrypted !== undefined ? message.regionCustomConfigEncrypted : new Uint8Array(),
      ));
  ...
  fromPartial<I extends Exact<DeepPartial<QueryCurrRegionHttpRsp>, I>>(object: I): QueryCurrRegionHttpRsp {
    const message = createBaseQueryCurrRegionHttpRsp();
    message.forceUdpate = (object.forceUdpate !== undefined && object.forceUdpate !== null)
      ? ForceUpdateInfo.fromPartial(object.forceUdpate)
      : undefined;
    message.stopServer = (object.stopServer !== undefined && object.stopServer !== null)
  ...
  toJSON(message: QueryRegionListHttpRsp): unknown {
    ...
    message.clientCustomConfigEncrypted !== undefined &&
      (obj.clientCustomConfigEncrypted = base64FromBytes(
        message.clientCustomConfigEncrypted !== undefined ? message.clientCustomConfigEncrypted : new Uint8Array(),
      ));
...
export const RegionInfo = {
  ...
  fromJSON(object: any): RegionInfo {
    return {
      ...
      clientSilenceDataVersion: isSet(object.clientSilenceDataVersion) ? Number(object.clientSilenceDataVersion) : 0,
      ...
      resVersionConfig: isSet(object.resVersionConfig) ? ResVersionConfig.fromJSON(object.resVersionConfig) : undefined,
      ...
      clientSilenceVersionSuffix: isSet(object.clientSilenceVersionSuffix)
        ...
        : "",
      useGateserverDomainName: isSet(object.useGateserverDomainName) ? Boolean(object.useGateserverDomainName) : false,
  ...
  toJSON(message: RegionInfo): unknown {
    ...
    message.resVersionConfig !== undefined &&
      (obj.resVersionConfig = message.resVersionConfig ? ResVersionConfig.toJSON(message.resVersionConfig) : undefined);
    ...
    message.nextResVersionConfig !== undefined && (obj.nextResVersionConfig = message.nextResVersionConfig
  ...
  fromPartial<I extends Exact<DeepPartial<RegionInfo>, I>>(object: I): RegionInfo {
    ...
    message.resVersionConfig = (object.resVersionConfig !== undefined && object.resVersionConfig !== null)
    ...
    message.nextResVersionConfig = (object.nextResVersionConfig !== undefined && object.nextResVersionConfig !== null)
